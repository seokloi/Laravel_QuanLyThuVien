     ...
     <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                ...
                <form action="<?php echo e(route('taomoimuon')); ?>" method="POST" role="post">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
                        ...
                        <div class="form-group col-md-12 col-lg-3">
                            ...
                            <input id="HoTen" disabled type="text" class="form-control" name="HoTen" placeholder="" />
                        </div>
                        <div class="form-group col-md-12 col-lg-3">
                                <label>Số điện thoại</label>
                            <input id="SoDT" disabled type="text" class="form-control" name="SoDT" placeholder="" />
                        </div>
                        <div class="form-group col-md-12 col-lg-3">
                            <label>Email</label>
                            <input id="Email" disabled type="email" class="form-control" name="Email" placeholder="" />
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                            ...
                                            <tr class="odd gradeX" align="left">
                                                <td><?php echo e($item['item']['TenSach']); ?></td>
                                                <td><?php echo e($item['item']['TacGia']); ?></td>
                                                <td><?php echo e($item['item']['TheLoai']['Ten']); ?></td>
                                                <td align="right">5000</td>
                                                <td align="center"><a href="<?php echo e(route('xoasachmuon', $item['item']['id'])); ?>"><i class="fa fa-trash fa-fw"></i></a>
                                            </tr>
                                    ...
                                    <tfoot>
                                        <tr align="right">
                                            ...
                                            <td colspan="3"><b>Tiền mượn : <?php echo e(Session::has('cart') ? $totalPrice : 0); ?></b></td>   
                                        </tr>
                                    </tfoot>
                                </table>
                            <?php endif; ?>
...
<?php echo $__env->make('nhanvien.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\quanlythuvien\resources\views/nhanvien/muonsach/taomoi/index.blade.php ENDPATH**/ ?>